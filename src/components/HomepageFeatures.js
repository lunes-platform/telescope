...
const FeatureList = [
  {
    ...
    description: <Translate>Your Future is here!</Translate>,
  },
  {
    title: <Translate>Lunes Documentation</Translate>,
    Svg: require("../../static/img/frame3.svg").default,
    description: <Translate>All our features in one place.</Translate>,
  },
  {
    title: <Translate>Lunes Blockchain</Translate>,
    Svg: require("../../static/img/frame2.svg").default,
    description: <Translate>Decentralization is our theme.</Translate>,
  },
];
