---
sidebar_position: 3
description: How to issue tokens with Lunes SDK
keywords: [transactions, blockchain, lunes, sdk, token airdrop of lunes sdk, lunes sdk, generate wallet,
generate transaction in lunes, lunes tokens, lunes wallet tokens]
---
